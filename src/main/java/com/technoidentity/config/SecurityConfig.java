package com.technoidentity.config;

import com.technoidentity.security.*;
import com.technoidentity.security.oauth2.CustomOAuth2UserService;
import com.technoidentity.security.oauth2.HttpCookieOAuth2AuthorizationRequestRepository;
        ...
        http
                ...
                .antMatchers(AUTH_WHITELIST).permitAll()
                    ...
                    .antMatchers("/api/auth/**", "/oauth2/**")
                        .permitAll()
                    .antMatchers("/api/files/**", "/api/users/profile-image/**").permitAll()
